...
router.post("/scrape", function(req, res) {
  ...
  request("https://www.buzzfeed.com/news?utm_term=.lnGKnoqKWD#.crlMbYoMdv", function(error, response, html) {
    ...
    $("a.link-gray").each(function(i, element) {
      ...
      var buzzfeed = "https://www.buzzfeed.com";
      result.link = buzzfeed + $(this).attr("href");
...
router.post("/save", function(req, res) {
  ...
  newArticleObject.summary = req.body.summary; // SUMMARY
